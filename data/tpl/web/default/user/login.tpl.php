...
<div class="system-login" <?php  if(!empty($_W['setting']['copyright']['background_img'])) { ?> style="background-image:url('<?php  echo tomedia($_W['setting']['copyright']['background_img']);?>')" <?php  } else { ?> style="background-image: url('https://img.alicdn.com/imgextra/i4/620941550/TB2WnfiiLBNTKJjSszcXXbO2VXa_!!620941550.png');" <?php  } ?>>
