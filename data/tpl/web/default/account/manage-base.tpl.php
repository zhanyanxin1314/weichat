...
<div id="js-account-manage-base" ng-controller="AccountManageBase" ng-cloak>
	...
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td ng-if="authstate && authurl"><div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#jointype" ng-click="editInfo('type', account.type)">修改</a></div></td>
		</tr>
		<tr>
