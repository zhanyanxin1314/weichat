...
class Apply_EweiShopV2Page extends PluginWebPage
{
	...
	protected function applyData()
	{
		...
		$apply_type = array('微信钱包');
		return array('id' => $id, 'status' => $status, 'apply' => $apply, 'list' => $list, 'totalcount' => $totalcount, 'totalmoney' => $totalmoney, 'member' => $member, 'totalpay' => $totalpay, 'totalcommission' => $totalcommission, 'agentLevel' => $agentLevel, 'set_array' => $set_array, 'apply_type' => $apply_type);
	}
