...
define('APP_URL', '//wei.cnyunmeng.com/');
...
if($action == 'env') {
	...
	if(version_compare(PHP_VERSION, '5.3.0') == -1) {
		...
		$ret['php']['version']['remark'] = 'PHP版本必须为 5.3.0 以上，强烈建议您使用 7.0 . <a href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58062">详情</a>';
	}
	...
	if($ret['php']['pdo']['ok']) {
		...
		$ret['php']['pdo']['remark'] = '您的PHP环境不支持PDO, 系统无法正常运行. <a target="_blank" href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58074">详情</a>';
	}
	...
	if($ret['php']['curl']['ok']) {
		...
		$ret['php']['curl']['remark'] = '您的PHP环境不支持cURL, 系统无法正常运行. <a target="_blank" href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58086">详情</a>';
	...
	if($ret['php']['ssl']['ok']) {
		...
		$ret['php']['ssl']['remark'] = '没有启用OpenSSL, 将无法访问公众平台的接口, 系统无法正常运行. <a target="_blank" href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58109">详情</a>';
	}
	...
	if($ret['php']['gd']['ok']) {
		...
		$ret['php']['gd']['remark'] = '没有启用GD, 将无法正常上传和压缩图片, 系统无法正常运行. <a target="_blank" href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58110">详情</a>';
	}
	...
	if($ret['php']['dom']['ok']) {
		...
		$ret['php']['dom']['remark'] = '没有启用DOMDocument, 将无法正常安装使用模块, 系统无法正常运行. <a target="_blank" href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58111">详情</a>';
	}
	...
	if($ret['php']['session']['ok'] == 0 || strtolower($ret['php']['session']['ok']) == 'off') {
		...
		$ret['php']['session']['remark'] = '系统session.auto_start开启, 将无法正常注册会员, 系统无法正常运行. <a target="_blank" href="//bbs.we7.cc/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58111">详情</a>';
	}
	...
	if($ret['write']['root']['ok']) {
		...
		$ret['write']['root']['remark'] = '本地目录无法写入, 将无法使用自动更新功能, 系统无法正常运行.  <a href="//bbs.we7.cc/">详情</a>';
	}
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="//www.we7.cc">官网</a></li>
					<li role="presentation"><a href="//www.we7.cc">访问论坛</a></li>
				</ul>
				<img src="?res=logo" width="18%"/>
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="//www.we7.cc">关于微擎</a> &nbsp; &nbsp; <a href="//bbs.we7.cc">微擎帮助</a> &nbsp; &nbsp; <a href="//www.we7.cc">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="//www.we7.cc"><b>微擎</b></a> v1.5.8 &copy; 2017 <a href="//www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="db[prefix]" value="ims_" readonly="readonly" onclick="javascript:alert('无论什么版本，千万不要修改表前缀！！！')">
					</div>
				</div>
				<div class="form-group">
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“微擎 - 公众平台自助开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">马上进入后台管理</a>
	</div>
